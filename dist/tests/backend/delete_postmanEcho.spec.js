...
(0, test_1.test)("DELETE request with auth header and body example validation - 200", (_a) => __awaiter(void 0, [_a], void 0, function* ({ request }) {
    // Define the API endpoint
    const apiEndpoint = (0, urlBuilder_1.getURL)("postmanEchoURL", "postmanEchoDelete");
    ...
    const response = yield request.delete(apiEndpoint, {
        headers,
        data: payload,
    });
